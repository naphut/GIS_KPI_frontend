        ...
        <div className="bg-white px-6 py-5 border-b border-slate-100">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-indigo-600 mt-1 text-xs font-bold uppercase tracking-wider">ASSET STEP :2</p>
              <p className="text-slate-500 mt-1 text-sm font-normal">តាមដានសម្ភារៈដែលបានទទួលពីស្តុក METFONE រួចហើយ ប៉ុន្តែមិនទាន់បានបង្កើតការប្រគល់ (Create Hand Over) ទៅកាន់ក្រុមការងារ។</p>
            </div>
            <div className="flex gap-2">
